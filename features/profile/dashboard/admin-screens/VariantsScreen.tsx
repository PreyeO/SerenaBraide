    ...
    <section className="py-7.5">
      ...
      {isLoading ? (
        ...
        <div className="py-12 text-center">
          <p className="text-[#6F6E6C] mb-4">No variants found for this product.</p>
          <button
            ...
            >
              <div className="flex gap-6">
                ...
                <div className="flex-1 grid grid-cols-2 md:grid-cols-3 gap-6">
                  <div>
                    <p className="text-xs text-[#6F6E6C] mb-2 font-medium">SKU</p>
                  ...
                  <div>
                    <p className="text-xs text-[#6F6E6C] mb-2 font-medium">Size</p>
                    <p className="font-semibold text-[#3B3B3B] text-base">
                      {variant.size}
                    </p>
                  </div>
                  ...
                  {variant.color && (
                    <div>
                      <p className="text-xs text-[#6F6E6C] mb-2 font-medium">Color</p>
                      <p className="font-semibold text-[#3B3B3B] text-base">
                        {variant.color}
                      </p>
                    </div>
                  ...
                  <div>
                    <p className="text-xs text-[#6F6E6C] mb-2 font-medium">Price</p>
                    <p className="font-semibold text-[#3B3B3B] text-base">
                      ₦{variant.price}
                    </p>
                  </div>
                  ...
                  <div>
                    <p className="text-xs text-[#6F6E6C] mb-2 font-medium">Status</p>
                    <span
                  ...
                  <div>
                    <p className="text-xs text-[#6F6E6C] mb-2 font-medium">Active</p>
                    <span
                      className={`inline-flex items-center px-3 py-1.5 rounded-full text-xs font-medium ${
                        variant.is_active
                          ? "bg-green-100 text-green-700"
