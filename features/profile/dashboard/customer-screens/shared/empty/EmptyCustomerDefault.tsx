...
const EmptyCustomerDefault: React.FC<EmptyCustomerProps> = ({
  ...
  return (
    <div className="w-full bg-[#F6F7F8] border border-[#F5F5F5] h-[293px] px-[34px]  rounded-[10px] ">
      <div className="flex justify-between  text-[#3B3B3B] py-[19px]">
      ...
      <div className=" flex flex-col items-center justify-center">
        ...
        <div className="pt-6 max-w-[396px] text-[#6F6E6C]   ">
          <Image
          ...
          <Paragraph
            ...
            content={contentOne}
          />
          <div className="flex items-center gap-[8px] pb-6 justify-center pt-[7px]">
            {useCircle ? (
            ...
            <Paragraph
              className=" text-[#3B3B3B]  font-medium text-center text-lg leading-[26px]"
              content={contentTwo}
            />
          </div>
        </div>
