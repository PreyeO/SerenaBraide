...
const SizeVariantCard: React.FC<SizeVariantCardProps> = ({
    ...
    return (
        <div
            ...
            className={`font-normal text-sm text-[#3B3B3B] max-w-40.75 lg:py-4 py-2.5 gap-0.75 border rounded-[5px] flex flex-col justify-center lg:px-4 px-2.5 transition-all duration-200 ${isOutOfStock
        ...
        >
            ...
            <Paragraph content={formatPrice(variant.price)} className="font-medium" />
