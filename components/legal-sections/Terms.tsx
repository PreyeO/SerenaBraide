...
const Terms = () => {
  return (
    <section className="lg:px-12.5 md:px-6 px-0 flex flex-col lg:gap-8.5 gap-6 pb-12.5">
      ...
      <LegalTypography title="Use of the Site">
        <LegalParagraph>
      ...
      <LegalTypography title="Eligibility">
        <LegalParagraph>
          ...
          jurisdiction, to place an order on this website. By placing an order,
          you confirm that you meet this requirement and are legally capable of
      ...
      <LegalTypography title="Product Information">
        <LegalParagraph>
          We aim to present products as accurately as possible. Colors,
      ...
      <LegalTypography title="Account Suspension & Termination">
        <LegalParagraph>
          We reserve the right to suspend or terminate your access to the
          website or your account at our discretion, including where we suspect
          fraud, misuse of the platform, or a breach of these Terms.
        </LegalParagraph>
      </LegalTypography>
      ...
      <LegalTypography title="Governing Law & Jurisdiction">
        <LegalParagraph>
