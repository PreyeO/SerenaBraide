...
import { singleProduct } from "@/constant/product";
import { CornerUpLeft, ShoppingBasket, Star } from "lucide-react";
  ...
  return (
    <section className="pt-[152px] px-16">
      ...
      <div className="flex items-center gap-2">
        <CornerUpLeft className="size-[18px]" color="#6F6E6C" />
        <UnderlineLink
          href="/categories/fragrances"
          text="Back to Fragrance"
